...
while (($fichier = $dir->read()) !== false){
	if (substr($fichier, strlen($fichier) - 3) == "sql" and substr($fichier, 0, 7) == "agility"){
		...
		echo "<tr><th><a href='../../communs/restauration_fichier_SQL.php?concours=$fichier'>$club ($codeclub) du $jour $mois $an sauvegardé le $joursauv $moissauv à $heuresauv:$minsauv</a></th></tr>";
	}
}
$dir->close();
?>
