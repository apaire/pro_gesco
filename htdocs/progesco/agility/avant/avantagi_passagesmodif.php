...
<body>
<h3 class="center">Modification des ordres de passage</h3>
<?php
...
?>
<form method="post" action="avantagi_passagesmodif_1.php" enctype="multipart/form-data">
<table class="general" align="center" border="1" rules="groups">
	...
	<tbody>
	<tr><th class="left"><div class="bouton"><a href="avantagi.php">RETOUR</a></div></th><th class="right"><input type="submit" name="choixepreuve" value="Valider" /></th></tr>
	</tbody>
</table>
</form>
</body>
