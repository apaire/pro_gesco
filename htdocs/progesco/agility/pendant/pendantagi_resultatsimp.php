<?php
session_start();
$titre = "<a href='pendantagi.php'>Pendant le concours</a> &gt; <a href='pendantagi_resultatsimp.php'>Impression des résultats</a>";
...
<body>
<h3 class="center">Impression des résultats</h3>
<?php
...
?>
<form method="post" action="pendantagi_resultatsimp_1.php" target="_blank" enctype="multipart/form-data">
