<?php
session_start();
$titre = "<a href='pendantagi.php'>Pendant le concours</a> &gt; <a href='pendantagi_cumulsimp.php'>Affichage des résultats des cumuls</a>";
...
<h3 class="center">Affichage des résultats d'une règle de cumul d'épreuves</h3>
<h4 class="center">Cliquez sur le nom de la règle à afficher</h4>
<?php
...
while ($row = mysql_fetch_assoc($result)){
	...
	echo "<tr><th><div class='boutonchoix'><a href='pendantagi_cumulsaff_1.php?idcumul=$id'>$nomcumul</a></div></th></tr>";
}
?>
